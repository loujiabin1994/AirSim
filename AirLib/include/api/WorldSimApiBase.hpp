...
namespace airlib
{
    ...
    public:
        ...
        virtual std::vector<std::vector<int>> createVoxelGrid(const Vector3r& position, const int& x_size, const int& y_size, const int& z_size, const float& res, const std::string& output_file) = 0;
